...
// ============================================================================
// Used in Client Components for Firebase Authentication.
// Initializes the Firebase app singleton and exports auth instance.
// ============================================================================
 ...
 * All values are public (safe to expose in browser bundles).
 */
...
// Export the auth instance for login/signup flows
